...
from dao.sala_dao import obtener_promedio_participantes, obtener_porcentaje_ocupacion_sala_por_edificio, obtener_salas
...
def get_porcentaje_ocupacion_por_edificio():
    return jsonify(obtener_porcentaje_ocupacion_sala_por_edificio())    
